      ...
      <header className="bg-white shadow-lg py-4 sticky top-0 z-50">
            ...
            <ul className="flex space-x-8">
              ...
              <li>
                {user ? (
                  <button
                    onClick={onLogout}
                    className="flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold text-md px-2 py-0 rounded-md transition"
                  >
                    Log out
                  </button>
                ) : (
                  <a
                    href="/login"
                    className="flex items-center gap-2 bg-yellow-500 hover:bg-yellow-500 text-blue-900 font-bold text-md px-2 py-0 rounded-md transition"
                  >
                    <LoginSVG />
                    Login
                  </a>
        ...
        >
          ...
          <div className="bottom-0 fixed px-4 py-2 w-full">
            <div className="pt-0 rounded-lg text-center w-full">
              {user ? (
                <button
                  onClick={onLogout}
                  className="text-center items-center bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold text-lg px-2 py-0 rounded-md transition w-full"
                >
                  Log out
                </button>
              ) : (
